...
const feedbackOptionsDiv = document.getElementById("feedback-submit-div");
...
// question = "money discrepency";

// const apiUrl = 'http://127.0.0.1:5000/predict?question=' + encodeURIComponent(question);
...
function showQuestion(question) {
    ...
    responsePage.appendChild(responseDiv);
...
function showAnswer(response) {
    ...
    const answer = response.Raw_data.replace(/\n/g, "<br>").trim();
    const score = (response.Score*100).toFixed(2);

    const responseDiv = responsePage.lastChild;
    ...
    thumbDown.addEventListener("click", () => {
        ...
        feedbackDiv.style.height = "420px";
        ...
        feedbackSubmit.addEventListener("click",() => {
            ...
            let boolArray = [feedbackCheckR.checked, feedbackCheckO.checked, feedbackCheckH.checked];
            let fbCheckArray = fbArray.filter((_, index) => Boolean(boolArray[index])); 
    ...
    thumbUp.addEventListener("click", () => {
        ...
        feedbackDiv.style.height = "300px";
...
function sendFeedback(json) {
    ...
    const url = 'https://api.clicdata.com/table/'+691817+'?api_version=2021.08';
    Http.open('POST', url);
